import LinkedList from '../src/DS/LinkedList/LinkedList';
import LinkedListNode from '../src/DS/LinkedList/LinkedListNode';
...
describe('Linked List', () => {
  ...
  test('should delete a node #4', () => {
    // non-existing node
    const deletedNode = new LinkedListNode(100);
    list.delete(deletedNode);
    expect(list.size).toBe(3);
    expect(list.head.value).toBe(0);
    expect(list.tail.value).toBe(2);
